...
public void the_user_should_able_to_see_options_in_dropdown_menu_at_home(Integer expectedCount, String optionList) {
	...
	assertEquals( expectedCount.intValue(),actualCount,"The number of dropdown options does not match the expected count");
...
public void the_user_clicks_buttons_of_on_the_homepage_without_sign_in_at_home(String butName, String dataStructureType) {
