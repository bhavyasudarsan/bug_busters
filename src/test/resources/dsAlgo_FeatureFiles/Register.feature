...
When user enters Username as "Ninjas@Numpy" and Password as "Numpy_TeamTesters" and Confirm Password as "Numpy_TeamTesters" and user clicks resgister button  
...
Given The user is on the user registration page  
When The user enters a username as "NumpyTesters" and Password as "12345678" and Confirm Password as "12345678" with spacebar characters other than digits and @/./+/-/_
And user clicks on register button
Then The user should able to see warning message "password_mismatch:The two password fields didn’t match."
